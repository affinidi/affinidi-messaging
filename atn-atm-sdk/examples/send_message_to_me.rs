...
use atn_atm_didcomm::{Attachment, Message};
use clap::Parser;
use serde_json::json;
...
async fn main()-> Result<(), Box<dyn Error>> {
    ...
    let atm_did = "did:peer:2.Vz6Mkurt7yqPtwDD5d6PRHfZy9xPwtR1GNJvxi6kXaEcqj9GP.EzQ3shs2AY7ETV2phU2M5fEuESfdRMjTF6AZUboF3kd1r7jeKw.SeyJ0IjoiZG0iLCJzIjp7InVyaSI6Imh0dHBzOi8vbG9jYWxob3N0OjcwMzcvIiwiYWNjZXB0IjpbImRpZGNvbW0vdjIiXSwicm91dGluZ19rZXlzIjpbXX19";

    let to_did = "did:peer:2.Vz6Mkurt7yqPtwDD5d6PRHfZy9xPwtR1GNJvxi6kXaEcqj9GP.EzQ3shs2AY7ETV2phU2M5fEuESfdRMjTF6AZUboF3kd1r7jeKw.SeyJ0IjoiZG0iLCJzIjp7InVyaSI6Imh0dHBzOi8vbG9jYWxob3N0OjcwMzcvIiwiYWNjZXB0IjpbImRpZGNvbW0vdjIiXSwicm91dGluZ19rZXlzIjpbXX19";
    ...
    let msg_to_bob = msg_to_bob.created_time(now).expires_time(now + 300).finalize();
